        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form class="w-full" action="{{ route('categories.update', ['category' => $category]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-100 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full border border-gray-200 rounded py-3 px-4 mb-3 leading-tight" 
                                    id="grid-first-name" type="text" value="{{ $category->name }}" name="name">
                            </div>
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input class="appearance-none block w-full border border-gray-200 rounded py-3 px-4 leading-tight focus:border-gray-500" 
                                id="grid-last-name" type="number" step="0.01" value="{{ $category->alert_value }}" name="alert_value">
                        </div>

                        <div class="flex flex-wrap my-6 justify-between">
                            <a href="{{ route('categories.index') }}" class="bg-white text-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Voltar</a>
